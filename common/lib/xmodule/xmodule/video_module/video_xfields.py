...
class VideoFields(object):
    ...
    display_name = String(
        display_name="Video Display Name", help="The name students see. This name appears in the course ribbon and as a header for the video.",
        default="Video",
    ...
    end_time = RelativeTime(  # datetime.timedelta object
        help="Time you want the video to end if you don't want the entire video to play. Formatted as HH:MM:SS. The maximum value is 23:59:59.",
    ...
    track = String(
        help="By default, students can download an .srt or .txt transcript when you set Download Transcript Allowed to True. If you want to provide a downloadable transcript in a different format instead, post that transcript file on the Files & Uploads page or on the Internet, and then add the URL for the transcript here. Students see a link to download the transcript below the video. You can also provide a transcript as a downloadable handout by using the Upload Handout field.",
        display_name="Downloadable Transcript URL",
        scope=Scope.settings,
        default=''
    )
    download_track = Boolean(
        help="Allow students to download the timed transcript. A link to download the file appears below the video. If you want to provide the transcript in a different format as a handout, add the transcript file by using the Upload Handout field.",
