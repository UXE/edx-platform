...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MigratedUser'
        db.create_table('syasi_migrated_users', (
            ...
            ('password', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ...
            ('birthdate', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('address', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('education', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('student', ['MigratedUser'])


    def backwards(self, orm):
        # Deleting model 'MigratedUser'
        db.delete_table('syasi_migrated_users')
    ...
    models = {
        ...
        'student.migrateduser': {
            'Meta': {'object_name': 'MigratedUser', 'db_table': "'syasi_migrated_users'"},
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'birthdate': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'country': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'education': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
