...
class VideoPage(PageObject):
    ...
    def caption_languages(self):
        ...
        :return dict:
        """
        selector = CSS_CLASS_NAMES['captions_lang_list']
        language_codes = self.q(css=selector).attrs('data-lang-code')
        language_names = self.q(css=selector).attrs('textContent')
